...
func SetupRouter(c *c.Env) *mux.Router{
	...
	s.HandleFunc("/{id:[0-9]+}", c.GetUser).Methods("GET"); log.Println("/v1/users/:id GET Show User")
	...
	s.HandleFunc("/{id:[0-9]+}", c.DeleteUser).Methods("DELETE"); log.Println("/v1/users/:id DELETE UserDelete")
	s.HandleFunc("/{id:[0-9]+}/undel", c.UndeleteUser).Methods("POST"); log.Println("/v1/users/:id/undel PUT UserUndelete")
	...
	s.HandleFunc("/{id:[0-9]+}", c.GetPerson).Methods("GET"); log.Println("/v1/persons/:id GET ShowPerson")
